...
public class WhatsApp {
	...
	public static boolean send(String chatName, String text) {
        ...
        driver.findElement(By.xpath("//div[contains(@title,'Escribe un mensaje')]")).click();
        driver.findElement(By.xpath("//div[contains(@title,'Escribe un mensaje')]")).sendKeys(text);
        driver.findElement(By.xpath("//div[contains(@title,'Escribe un mensaje')]")).sendKeys(Keys.ENTER);
